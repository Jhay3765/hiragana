...
const Box = (props: Game) => {
  ...
  const { name, game, img } = props;
  return (
    <Link href={`/games/${game.toLowerCase()}`} className=" relative">
      <div
        className={`relative items-center hover:bg-teal-400 hover:shadow-[10px_10px_0px_rgba(0,0,0,1)] transition-all duration-400 border-2 border-b-4 rounded-lg border-black  p-10 w-fit`}
      >
